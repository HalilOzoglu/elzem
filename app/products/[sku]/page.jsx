  ...
  try {
    ...
    const serializedFamily = JSON.parse(
      JSON.stringify({
        ...
        // Sadece gerçekten dolu olan görsel alanlarını geçir
        productImg1: family.productImg1 || null,
        productImg2: family.productImg2 || null,
        productImg3: family.productImg3 || null,
        productImgMini: family.productImgMini || null,
