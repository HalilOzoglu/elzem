...
const CartPage = () => {
  ...
  const handleQuantityChange = (sku, value) => {
    ...
    updateCartQuantity(sku, numericValue);
  };
                ...
                <div className="flex-1">
                  ...
                  {item.variantInfo && (
                    <div className="text-sm text-gray-500">
                      {item.variantInfo.v1 && (
                        <span>{item.variantInfo.v1} </span>
                      )}
                      {item.variantInfo.v2 && (
                        <span>{item.variantInfo.v2} </span>
                      )}
                      {item.variantInfo.v3 && (
                        <span>{item.variantInfo.v3}</span>
                      )}
                    </div>
                  )}
                  <div className="mt-2 flex items-center">
                    <span className="mr-2 text-gray-600">Adet:</span>
